...
export function MetricOrbit({ metrics }: MetricOrbitProps) {
  return (
    <div className="relative min-h-72 overflow-hidden rounded-lg border border-[#315A75] bg-[#102A43] p-6 text-white">
      ...
      <div className="relative z-10 flex min-h-60 items-center justify-center">
        <div className="rounded-full border border-[#9FB3C8] bg-[#EAF0F5] px-6 py-5 text-center text-[#102A43] shadow-[0_0_60px_rgba(0,229,255,0.24)]">
      ...
      {metrics.map((metric, index) => {
        ...
        return (
          ...
          >
            <p className="text-xs text-[#C4D4DF]">{metric.label}</p>
